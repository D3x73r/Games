package utils.chart
{
	...
	{
		//this variable stores the XML path
		...
		//main function
		public function LinesChart(XMLPath:String)
		{
			//loading the XML path
			xmlPath = XMLPath;
			...
			xmlLoader.addEventListener(Event.COMPLETE, parseXmlFile);
		...
		private function parseXmlFile(e:Event):void
		{
